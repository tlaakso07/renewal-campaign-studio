...
Remote source and deployment state are recorded in [handoff.md](handoff.md). The application remains a local prototype until the hosted database, media storage, identity and render-worker migration is complete.
